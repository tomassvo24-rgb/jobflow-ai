  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl p-5 text-white" style={{ background: "linear-gradient(135deg,#0D1B2A,#1a3050)" }}>
        <div className="font-poppins text-base font-bold mb-1.5 text-white">📬 Pracovní novinky</div>
        ...
        {subscribed ? (
          ...
          <div className="flex flex-col gap-2">
            ...
            <button onClick={subscribe} className="bg-brand-teal text-white rounded-full px-4 py-2.5 text-sm font-bold hover:opacity-90 transition-opacity">Přihlásit se k odběru</button>
          </div>
        )}
      </div>
      ...
      <div className="bg-accent border border-brand-teal/20 rounded-xl p-4 text-center relative">
        ...
        <div className="font-poppins font-bold text-sm mb-1">Jazykové kurzy online</div>
        <p className="text-xs text-muted-foreground mb-3 leading-relaxed">Zlepši svoji angličtinu a němčinu. Kurzy od 299 Kč/měsíc.</p>
        <button className="w-full px-4 py-2 rounded-full bg-brand-teal text-white text-xs font-semibold hover:opacity-90 transition-opacity">Zjistit více</button>
      </div>

      {/* Tip of day */}
      <div className="bg-white border border-border rounded-xl p-4 shadow-sm">
        <div className="font-poppins font-bold text-sm mb-3">💡 Tip dne</div>
      ...
      <div className="bg-accent border border-brand-teal/20 rounded-xl p-4 text-center relative">
        <span className="absolute top-2 right-2.5 text-[9px] font-bold tracking-widest text-muted-foreground font-mono uppercase">Partneři</span>
        <div className="text-3xl mb-2">💻</div>
        <div className="font-poppins font-bold text-sm mb-1">IT kurzy — Czechitas</div>
        <p className="text-xs text-muted-foreground mb-3 leading-relaxed">Nauč se programovat a získej práci v IT za 6 měsíců.</p>
        <button className="w-full px-4 py-2 rounded-full bg-brand-blue text-white text-xs font-semibold hover:opacity-90 transition-opacity">Chci vědět více</button>
      </div>
    </div>
  );
}