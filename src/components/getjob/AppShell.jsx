      ...
      <footer className="hidden md:block border-t border-blue-700 py-5 mt-5 bg-[hsl(var(--muted))]">
        <div className="max-w-[960px] mx-auto px-6 flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex gap-4 text-xs text-white/50">
            <span className="hover:text-white/80 cursor-pointer transition-colors text-[hsl(var(--foreground))]">O projektu</span>
            <span className="hover:text-white/80 cursor-pointer transition-colors text-[hsl(var(--foreground))]">Kontakt</span>
            <span className="hover:text-white/80 cursor-pointer transition-colors text-[hsl(var(--foreground))]">Ochrana dat</span>
          </div>
