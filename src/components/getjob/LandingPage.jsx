                  ...
                  <div className="px-4 mt-2">
                    <div className="rounded-2xl border p-4" style={{ borderColor: "#e3e8f0", boxShadow: "0 10px 40px -12px rgba(13,27,42,0.12)" }}>
                      ...
                      <div className="mt-3 space-y-1 text-[11px]" style={{ color: "#5b6577" }}>
                        <div className="flex items-center gap-1.5">✅ Figma & Prototyping</div>
                        <div className="flex items-center gap-1.5">✅ VŠ projekty</div>
                      </div>
                    </div>
                  </div>
                  {/* AI message */}
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl font-extrabold tracking-tight">
              ...
              <span style={{ background: "linear-gradient(90deg,#2563eb,#14b8a6)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent", textDecoration: "underline", textDecorationColor: "transparent", backgroundImage: "linear-gradient(90deg,#2563eb,#14b8a6)" }}>
                získání práce
              </span>.
            </h2>
          </div>
          <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                style={{ borderColor: "#e3e8f0" }}
              >
                <div className="w-12 h-12 rounded-2xl grid place-items-center text-2xl transition-all" style={{ background: "#e6f0ff" }}>
                  {f.icon}
                </div>
