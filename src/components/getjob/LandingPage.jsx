    ...
    <div className="min-h-screen font-poppins bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md border-b bg-card/85 border-border">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <img src="https://media.base44.com/images/public/69fc9f905d0066a88e5bce3f/61c16d602_e9868ad2-36e2-46c9-921c-b693ef439451.png" alt="GetJob.cz" className="h-10 w-auto object-contain hidden dark:block" />
